...
import com.kbskyblock.teams.gui.WarpsGUI;
...
@NoArgsConstructor
public class WarpsCommand<T extends Team, U extends KBSkyblockUser<T>> extends Command<T, U> {
    ...
    public boolean execute(U user, T team, String[] arguments, KBSkyblockTeams<T, U> teams) {
        ...
        player.openInventory(new WarpsGUI<>(team, player, teams).getInventory());
        return true;
    }
