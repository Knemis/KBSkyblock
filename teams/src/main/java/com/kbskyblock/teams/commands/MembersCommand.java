...
import com.kbskyblock.teams.gui.MembersGUI;
...
@NoArgsConstructor
public class MembersCommand<T extends Team, U extends KBSkyblockUser<T>> extends Command<T, U> {
    ...
    public boolean execute(U user, T team, String[] arguments, KBSkyblockTeams<T, U> teams) {
        ...
        player.openInventory(new MembersGUI<>(team, player, teams).getInventory());
        return true;
    }
