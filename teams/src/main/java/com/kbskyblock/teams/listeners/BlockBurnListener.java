...
@AllArgsConstructor
public class BlockBurnListener<T extends Team, U extends KBSkyblockUser<T>> implements Listener {
    ...
    public void onBlockBurn(BlockBurnEvent event) {
        ...
        teams.getTeamManager().getTeamViaLocation(event.getBlock().getLocation()).ifPresent(team -> {
            TeamSetting teamSetting = teams.getTeamManager().getTeamSetting(team, SettingType.FIRE_SPREAD.getSettingKey());
